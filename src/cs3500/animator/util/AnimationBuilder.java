...
/**
 * This interface resembles a builder pattern for AnimatorModel.
 *
 * @param <Doc> AnimatorModel
 */
public interface AnimationBuilder<Doc> {
   ...
   * @param o1   The initial orientation of the shape
   ...
   * @param o2   The final orientation of the shape
   * @return This {@link AnimationBuilder}
   */
  AnimationBuilder<Doc> addMotion(String name,
                                  int t1, int x1, int y1, int w1, int h1, int r1,
                                  int g1, int b1, int o1,
                                  int t2, int x2, int y2, int w2, int h2, int r2,
   ...
   * @param o    The orientation of the shape
   * @return This {@link AnimationBuilder}
   */
